...
async function getPaymentObj(req,type){
    ...
    if(req.body.createdBy) {
        newPayment.createdBy = req.body.createdBy
    }
    if(req.body.updatedBy) {
        newPayment.updatedBy = req.body.updatedBy
    }
    if(req.body.customer) {
        newPayment.customer= req.body.customer
    }
    if(req.body.receiptNumber) {
        newPayment.receiptNumber = req.body.receiptNumber
    }
    if(req.body.designation) {
        newPayment.designation = req.body.designation
    }
    if(req.body.date) {
        newPayment.date = req.body.approvedByAdmin
    }
    if(req.body.approvedByAdmin) {
        newPayment.approvedByAdmin = req.body.approvedByAdmin
    }
